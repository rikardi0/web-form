...
<body>
    <div class="container col-11">
        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#7B221E" class="bi bi-x-octagon-fill"
            viewBox="0 0 16 16">
            <path
        ...
        <a href="index.html">
            ...
            <button href="#" class="btn btn-outline-danger">Volver a intentarlo</button>
        </a>
...
<script>
    const errorCode = window.location.search.substring(1).split("=")[1];

    let errorMessage;

    if (errorCode === 'duplicate_rif') {
        errorMessage = "El RIF ingresado ya existe. Por favor, intente con otro RIF.";
    } else if (errorCode === 'duplicate_email') {
        errorMessage = "El Email ingresado ya esta registrado. Por favor, utilice otro email.";
    } else if (errorCode === 'general_error') {
        errorMessage = "Error al procesar la información. Por favor, intente nuevamente.";
    } else {
